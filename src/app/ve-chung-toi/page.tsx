        ...
        <main className="min-h-screen pt-20">
            <div className="bg-slate-900 py-24 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4">
                    ...
                    <h1 className="text-4xl md:text-6xl font-display font-bold text-white mb-6 animate-fade-in-up delay-100">Kiến Tạo Vẻ Đẹp Từ <br /> <span className="text-primary">{settings.site_name || "Tâm Huyết & Y Đức"}</span></h1>
