    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-6">
                ...
                <h1 className="text-2xl font-bold text-slate-800">Thêm nội dung trình diễn</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary outline-none"
                        placeholder="Ví dụ: Máy CT SOMATOM Force"
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        rows={3}
                        className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary outline-none"
                        placeholder="Mô tả cho trang thiết bị hoặc thông tin thêm cho các mục khác..."
                    ></textarea>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        placeholder='Ví dụ cho Banner: { "subtitle": "...", "features": [...] }'
                    ></textarea>
                </div>
